		...
		<div className="Home_home">
			<div className="FIRST">
				...
				<div style={{ position: "relative", top: "300px", left: "140px" }}>
					<img className="front" src={(process.env.NODE_ENV === 'production' ? "/WEB_MiliDream_Dreamers" : "") + "/img/home/intro_2.svg"} />
					<div style={{ position: "absolute", top: "-320px", left: "140px" }}>
						<img className="back" src={(process.env.NODE_ENV === 'production' ? "/WEB_MiliDream_Dreamers" : "") + "/img/home/intro_1.svg"} />
					</div>
					<div style={{ position: "absolute", top: "170px", left: "-50px" }}>
						<img className="third" src={(process.env.NODE_ENV === 'production' ? "/WEB_MiliDream_Dreamers" : "") + "/img/home/intro_3.svg"} />
					</div>
				</div>
				<div>
					<h1
          ...
          `}
			...
			<footer className="footer">
				...
				>
					<img
						src={(process.env.NODE_ENV === 'production' ? "/WEB_MiliDream_Dreamers" : "") + "/img/Footer/Footer(Simply).svg"}
						style={{
							backgroundColor: "#566270",
						}}
					/>
